...
Select Helpers (ask **?select\_helpers** in console for more
information)
...
When we ask whether a variable equals to what value, we use **two**
equal signs
...
When we want the variable with values which are not equal to a
particular number
...
If you want to arrange multi-variables, the variable you put first will
be arranged firstly.
